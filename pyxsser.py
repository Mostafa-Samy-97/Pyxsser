...
epilog="""
Github: https://github.com/Mostafa-Samy-97/Pyxsser
Version: 1.0
"""
def check(getopt):
...
def start():
	...
	pos_opt.add_argument("-u",metavar="",help="Target url (e.g. http://example.com)")
